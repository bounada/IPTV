...
import xbmcaddon
import logging
from tv import tags, MesutKurtis, SamiYusuf, MaisShalash
...
streams = {
  'SamiYusuf': sorted((i for i in SamiYusuf), key=lower_getter('name')),
  'MesutKurtis': sorted((i for i in MesutKurtis), key=lower_getter('name')),
  'MaisShalash': sorted((i for i in MaisShalash), key=lower_getter('name')),
}
